...
public class UCJS_DestinationScriptJeep2 : MonoBehaviour {
...
//	public GameObject CurrentVehicleSpawnPosition;
	...
	public UCJS_GameplayJeep2 gamePlayScript;
...
//			cameraObject.SetActive (false);
        ...
        UCJS_GameplayJeep2.isTimeStarted = false;
		gamePlayScript.CancelInvoke ("timeChekker");

		ParentObject.GetComponent<UCJS_StopHandlerScriptJeep2> ().ActivateNewSpot ();
	}
