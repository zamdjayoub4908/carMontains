...
public class UCJS_LevelSelectionManagerJeep1 : MonoBehaviour {
...
//		PlayerPrefs.DeleteAll();
	...
	void CheckUnlockedLevels(){
		totalUnlockedLevel = PlayerPrefs.GetInt ("TotalLevelUnlockedJeep1", 1);
...
//		}
	...
	public void LevelClicked(int index){ 
		index--;
		PlayerPrefs.SetInt ("CurrentLevelNumberJeep1", index);
